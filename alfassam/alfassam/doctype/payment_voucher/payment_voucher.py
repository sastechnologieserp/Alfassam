# Copyright (c) 2023, sastechnologies and contributors
...
class PaymentVoucher(AccountsController):
	def __init__(self, *args, **kwargs):
		super(PaymentVoucher, self).__init__(*args, **kwargs)
